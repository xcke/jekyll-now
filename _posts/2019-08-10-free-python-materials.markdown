---
title: Free Python materials
layout: post
categories: netdev
---
Sources are mostly from the [EbookFoundation](https://github.com/EbookFoundation/free-programming-books) gitlab page - you might want to check out for regular updates:-)
...
So many information available these days, but using a platform like o'reilly Learning Platform also makes sense. 
